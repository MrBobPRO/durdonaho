...
<div class="owl-carousel-container">
    <div class="owl-carousel card-carousel">
        ...
        <div class="owl-carousel__item card">
            ...
            <img class="card__image" src="{{ asset('img/authors/' . $author->image) }}" alt="{{ $author->name }}">
            <p class="card__text">{{ $author->biography }}</p>
            ...
            <div class="card__publish">
                ...
                <a class="card__publish-author" href="#"><span class="material-icons">person</span> {{ $author->name }}</a>
